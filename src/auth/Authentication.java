...
// the Free Software Foundastion, either version 2.1 of the License, or (at your
...
public interface Authentication {
     ...
     *
     * @param tsdb the current tsdb
     * @param chan the current channel
     * @return returns true if the authc/authz state is valid for the provided channel
     */
